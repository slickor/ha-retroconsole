...
- **v0.30.3 Update:** Introduced Advanced Control Mode with animated gauge UI for media players and climate entities.
...
* **Phase 7:** Advanced UI & Ecosystem (v0.30.3) (In Progress).
